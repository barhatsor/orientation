...
window.addEventListener('deviceorientation', (e) => {
  ...
  logEl.children[2].innerHTML = 'deviceorientation event: <br> alpha: ' + e.alpha + ', beta: ' + e.beta + ', gamma: ' + e.gamma + ', webkitCompassHeading: ' + e.webkitCompassHeading;
...
window.addEventListener('deviceorientationabsolute', (e) => {
  ...
  logEl.children[0].innerHTML = 'deviceorientationabsolute event: <br> alpha: ' + e.alpha + ', beta: ' + e.beta + ', gamma: ' + e.gamma + ', webkitCompassHeading: ' + e.webkitCompassHeading;
