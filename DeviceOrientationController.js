...
window.addEventListener('deviceorientationabsolute', (e) => {
  ...
  logEl.children[0].innerHTML = 'deviceorientation event: <br> alpha: ' + e.alpha.toFixed(2) + ', beta: ' + e.beta.toFixed(2) + ', gamma: ' + e.gamma.toFixed(2) + ', webkitCompassHeading: ' + e.webkitCompassHeading.toFixed(2);
